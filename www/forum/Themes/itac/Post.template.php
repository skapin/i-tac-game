...
<form action="', $scripturl, '?action=', $context['destination'], ';', empty($context['current_board']) ? '' : 'board=' . $context['current_board'], '" method="post" accept-charset="', $context['character_set'], '" name="postmodify" id="postmodify" onsubmit="submitonce(this);saveEntities();" enctype="multipart/form-data">';
  ...
  // If the user wants to see how their message looks - the preview table is where it's at!
	echo '
 <div id="preview_section"', isset($context['preview_message']) ? '' : ' style="display: none;"', ' class="preview">
  <table class="post">
    <tr>
     <th id="preview_subject">', empty($context['preview_subject']) ? '' : $context['preview_subject'], '</th>
    </tr>
    <tr>
    <td>
     <div id="preview_body">', empty($context['preview_message']) ? '' : $context['preview_message'], '</div>
    </td>
   </tr>
  </table>
 </div>';
...
<table class="postForm">
 <tr>
  <th colspan="2">',isset($context['current_topic'])?'
   <input type="hidden" name="topic" value="' . $context['current_topic'] . '" />':'','', $context['page_title'], '</th>
 </tr>';
  ...
  <tr', empty($context['post_error']['messages']) ? ' style="display: none"' : '', ' id="errors">
   <td></td>
   <td>
    <div',empty($context['error_type'])||$context['error_type']!='serious'?' style="display:none;"':'',' id="error_serious">',$txt['error_while_submitting'],'</div>
    <div id="error_list">
  ...
  <tr',$context['locked']? '':' style="display: none"', ' id="lock_warning">
   ...
   <td>',$txt['smf287'],'</td>
	...
	if (isset($context['name']) && isset($context['email'])){
	  echo '
  <tr>
   <td',isset($context['post_error']['long_name']) || isset($context['post_error']['no_name']) || isset($context['post_error']['bad_name']) ?' style="color:red;"':'',' id="caption_guestname" class="labels">
    ', $txt[68],':
   </td>
   <td>
    <input type="text" name="guestname" size="25" value="', $context['name'], '" tabindex="', $context['tabindex']++, '" />
	  ...
	  if (empty($modSettings['guest_post_no_email'])){
	    echo '
  <tr>
   <td', isset($context['post_error']['no_email']) || isset($context['post_error']['bad_email'])?' style="color:red;"':'',' id="caption_email" class="labels">
   ', $txt[69], ':
   </td>
   <td>
	...
	echo '
  <tr>
   <td', isset($context['post_error']['no_subject']) ?' style="color:red;"' : '', ' id="caption_subject" class="labels">
    ', $txt[70], ':
   </td>
   <td>
  ...
  <tr>
   ...
   <td>
	...
	if ($context['make_poll']){
	  echo '
  <tr>
   <td', isset($context['post_error']['no_question']) ? ' style="color: red;"':'', '" id="caption_question" class="labels">
    ', $txt['smf21'], ':
   </td>
   <td align="left">
  ...
  <tr>
   <td class="labels">', $txt['poll_options'], ':</td>
   <td><input type="text" name="poll_max_votes" size="2" value="', $context['poll_options']['max_votes'], '" /> ', $txt['poll_options5'], '</td>
  </tr>
  <tr>
   <td></td>
   <td>', $txt['poll_options1a'], ' <input type="text" id="poll_expire" name="poll_expire" size="2" value="', $context['poll_options']['expire'], '" onchange="pollOptions();" /> ', $txt['poll_options1b'], '</td>
  </tr>
  <tr>
   <td></td>
   <td><label for="poll_change_vote"><input type="checkbox" id="poll_change_vote" name="poll_change_vote"', !empty($context['poll_options']['change_vote']) ? ' checked="checked"' : '', ' class="check" /> ', $txt['poll_options7'], '</label></td>
  </tr>
  <tr>
   <td></td>
   <td>
  ...
  <tr>
   <td colspan="2" style="padding-left: 5ex;">
    <a href="javascript:swapOptions();"><img src="', $settings['images_url'], '/expand.gif" alt="+" id="postMoreExpand" /></a> <a href="javascript:swapOptions();">', $txt['post_additionalopt'], '</a>
   </td>
  </tr>';
...
<table class="resume">
 ...
 <tr>
  <td id="msg', $post['id'], '">
   <div align="right"><a href="#top" onclick="return insertQuoteFast(', $post['id'], ');">', $txt[260], '</a></div>
